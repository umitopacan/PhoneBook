    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.setOnItemClickListener(new ContactsAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Pair<View, String> circlePair = Pair.create(view.findViewById(R.id.circle), getString(R.string.transition_circle));
                Pair<View, String> namePair = Pair.create(view.findViewById(R.id.name), getString(R.string.transition_name));
                Pair<View, String> phonePair = Pair.create(view.findViewById(R.id.phone), getString(R.string.transition_phone));

                ActivityOptionsCompat options = ActivityOptionsCompat.makeSceneTransitionAnimation(
                        MainActivity.this, circlePair, namePair, phonePair
                );
